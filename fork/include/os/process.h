...
typedef struct PCB {
  ...
  uint32	pagetable[(MEM_MAX_VIRTUAL_ADDRESS >> MEM_L1FIELD_FIRST_BITNUM)+1/* Put the size of the L1 page table here */]; // Statically allocated page table
  Link		*l;		// Used for keeping PCB in queues
} PCB;

extern PCB	*currentPCB;
extern uint32 refcount[512]; // PhyMem: 2M, Pagesize: 4K
