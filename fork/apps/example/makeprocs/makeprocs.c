...
#define FORK1 "fork_test1.dlx.obj"
#define FORK2 "fork_test2.dlx.obj"
...
void main (int argc, char *argv[])
{
  ...
  Printf("-------------------------------------------------------------------------------------\n");
  Printf("makeprocs (%d): for the case fork test 1\n", getpid());
  process_create(FORK1, s_procs_completed_str, NULL);
  ...
  Printf("\n\n\n-------------------------------------------------------------------------------------\n");
  Printf("makeprocs (%d): for the case fork test 2\n", getpid());
  process_create(FORK2, s_procs_completed_str, NULL);
